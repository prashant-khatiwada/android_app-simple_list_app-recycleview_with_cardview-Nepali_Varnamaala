...
import com.momobites.prash.varnamaala.Data.Data06Food;
...
public class VegetablesAndSpices extends Fragment {

    public VegetablesAndSpices(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new WordAdapter(getContext(), Data06Food.getVegetables());
        // Set Adapter
